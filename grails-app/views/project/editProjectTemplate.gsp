...
function saveProjectTemplateInfo(status){
	...
	$.ajax({
		type:"post",
		url:"${ grailsApplication.config.grails.app.name}/project/updateProjectTemplateInfo",
...
<div class="toEditProject" >
		<div class="head">
			...
			<div style="float: right;margin-right: 10px;margin-top: 10px;">
				<button type="button" class="btn btn-primary btn-sm" style="width: 80px;" onclick="saveProjectTemplateInfo(0)">保存</button>
			...
			<form id="myForm">
				...
				<table style="width: 100%">
					<tr>
						...
						<td style="width: 35%"><input type="text" id="name" name="name" value="${project.name }"></td>
						<td style="width: 15%">项目编号:</td>
						<td style="width: 35%"><input type="hidden" id="code" name="code" value=""></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="status" value="0" id="project_status">
					...
					<tr>
						...
						<td colspan="3">
							<textarea rows="5" cols="20" style="width: 90%; height: 100px;" id="desc" name="desc">${project.desc }</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<textarea rows="5" cols="20" style="width: 90%; height: 100px;" id="target" name="target">${project.target }</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<textarea rows="5" cols="20" style="width: 90%; height: 100px;" id="milestone" name="milestone">${project.milestone }</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<textarea rows="5" cols="20" style="width: 90%; height: 100px;" id="evaluation_criterion" name="evaluation_criterion">${project.evaluation_criterion }</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<textarea rows="5" cols="20" style="width: 90%; height: 100px;" id="constraint_condition" name="constraint_condition">${project.constraint_condition }</textarea>
						</td>
					</tr>
