...
function saveProjectAnalystInfo(status){
	...
	$.ajax({
		type:"post",
		url:"${ grailsApplication.config.grails.app.name}/project/shareProjectTemplateToAnthorAnalyst",
...
<div class="toEditProject" >
		<div class="head">
			<div style="float: left;margin-left: 10px;color: #fff;font-size: 20px;margin-top: 15px;">分享项目模板</div>
