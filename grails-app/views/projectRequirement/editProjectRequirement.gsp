...
<script src="${ grailsApplication.config.grails.app.name}/js/projectRequirement/projectRequirementEdit.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<div class="toEditProject" >
		<div class="head">
			...
			<div style="float: right;margin-right: 10px;margin-top: 10px;">
				<button type="button" class="btn btn-primary btn-sm" style="width: 80px;" onclick="editProjectRequirementInfo(2)">提交</button>
		...
		<div style="margin-top: 15px;text-align:  -moz-left;">
			<form id="myForm">	
				...
				<input type="hidden" name="requirement_state" id="requirement_state" value="${projectRequirement.requirement_state }" >
