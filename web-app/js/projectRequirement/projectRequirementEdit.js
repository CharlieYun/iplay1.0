...
function editProjectRequirementInfo(prStatue){
	...
	if(selectId == 10){
		...
		updateProjectRequirementInfoSpecial();
		return ;
	}
		...
		updateProjectRequirementInfoStar();
		return ;
	}
...
//				需求结束时间
		...
		$.ajax({
			type:"post",
			url:projectURI.defcon+"/projectRequirement/editProjectRequirementInfo",
			data: {queryIds:queryIds,requirementName:requirementName,begin_time:begin_time,end_time:end_time,objectType:objectType,prStatue:prStatue,rating35:rating35,rating50:rating50,portion35:portion35,portion50:portion50,valuesAmount:valuesAmount,valuesIdsAmount:valuesIdsAmount,valuesInfluence:valuesInfluence,valuesIdsInfluence:valuesIdsInfluence,valuesReputation:valuesReputation,valuesIdsReputation:valuesIdsReputation,objtye:objtye,projectRequirementId:projectRequirementId,valueshoster:valueshoster,valuesIdshoster:valuesIdshoster,valuesguester:valuesguester,valuesIdsguester:valuesIdsguester},
			success:function(msg){
				alert(msg);
				window.opener.location.reload();
				toCloseProjectRequirement()
...
function updateProjectRequirementInfoSpecial(){
	$.ajax({
		type:"post",
		url:projectURI.defcon+"/projectRequirement/updateProjectRequirementInfoSpecial",
...
function updateProjectRequirementInfoStar(){
	$.ajax({
		type:"post",
		url:projectURI.defcon+"/projectRequirement/updateProjectRequirementInfoStar",
		data: $("#myForm").serialize(),   
		success:function(msg){
			alert(msg);
			window.opener.location.reload();
